...
import 'package:marvelwiki/musica/mateusmusica.dart';
import 'package:marvelwiki/galeria/mateusfoto.dart';
...
class Mateus extends StatelessWidget {
  const Mateus({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("MATEUS", style: TextStyle(
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                "O cnpj mais trancado na receita federal. Dono de uma empresa de criação de e-commerce e agiotagem. Viciado em tatuagens, motos e ford ka 98 roxos.",
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 15,
                ),
                        ...
                        children: [
                          Expanded(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.push(
                                    context, MaterialPageRoute(builder: (context) => Mateusfoto()));
                              },
                            ),
                          ),
                        ],
                        ...
                        children: [
                          Expanded(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.push(
                                context, MaterialPageRoute(builder: (context) => MateusMusica()));
                                },
                            ),
                          ),
                        ],
